...
//  bookshop
//
//  Created by macos.li on 2022/5/17.
//
...
class CommonUtil {
    ...
    private static var bookList_02: [Book] = [Book]()
    ...
    static func addShoppingCar(book: Book) -> Response {
        ...
        if(quantity <= 0) {
            return Response(isSuccess: false, msg: "售罄")
        }
    ...
    static func loadBooks(){
        ...
        bookList.append(Book(id: 6, name: "Java编程思想", desc: "《Java编程思想》是2007年机械工业出版社出版的图书，作者是埃克尔，译者是陈昊鹏。", price: 59.0, quantity: 0, cover: UIImage(named: "6")!))
            bookList_02.append(Book(id: 1, name: "白夜行", desc: "《白夜行》是日本作家东野圭吾创作的长篇小说，也是其代表作。该小说于1997年1月至1999年1月间连载于期刊，单行本1999年8月在日本发行。故事围绕着一对有着不同寻常情愫的小学生展开。1973年，大阪的一栋废弃建筑内发现了一具男尸，此后19年，嫌疑人之女雪穗与被害者之子桐原亮司走上截然不同的人生道路，一个跻身上流社会，一个却在底层游走，而他们身边的人，却接二连三地离奇死去，警察经过19年的艰苦追踪，终于使真相大白。", price: 19.0, quantity: 1, cover: UIImage(named: "1")!))
            saveBookList()
        }
    }
